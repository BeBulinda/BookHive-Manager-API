...
if ($_SESSION['logged_in_user_type_details']['name'] == "STAFF") {
    if ($_SESSION['user_details']['level_type'] == $users->getUserTypeRefId("PUBLISHER")) {
        $user = "PUBLISHER " . $_SESSION['logged_in_user_type_details']['name'];
    } else if ($_SESSION['user_details']['level_type'] == $users->getUserTypeRefId("BOOK SELLER")) {
        $user = "BOOK SELLER " . $_SESSION['logged_in_user_type_details']['name'];
    } else if ($_SESSION['user_details']['level_type'] == $users->getUserTypeRefId("BOOKHIVE")) {

...
if (!empty($_POST)) {
    ...
    App::redirectTo("?view_book_levels");
}
?>

<div id="content">
    <div id="content-header">
        <div id="breadcrumb"> <a href="?home" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="?view_book_levels">Book Levels</a> <a href="?add_book_level" class="current">Add Book Level</a> </div>
                ...
                <div class="widget-box">          
                    <div class="widget-content nopadding">
                        <form class="form-horizontal" method="post" name="basic_validate" id="basic_validate" novalidate="novalidate">
                            <input type="hidden" name="action" value="add_book_level"/>

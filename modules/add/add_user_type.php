...
<div id="content">
    <div id="content-header">
        <div id="breadcrumb"> <a href="?home" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="?view_user_types">User Types</a> <a href="?add_user_type" class="current">Add User Type</a> </div>
        <h1>Add User Type</h1>
    </div>
                ...
                <div class="widget-box">          
                    <div class="widget-content nopadding">
                        <form class="form-horizontal" method="post" name="basic_validate" id="basic_validate" novalidate="novalidate">
                            ...
                            <div class="control-group">
                                <label class="control-label">Is staff</label>
                                <div class="controls">
                                    <select name="is_staff" id="gender">

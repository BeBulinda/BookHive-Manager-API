...
<div id="content">
    <div id="content-header">
        <div id="breadcrumb"> <a href="?home" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="?view_counties" class="current">Counties</a> </div>
        <h1>Counties</h1>
    </div>
                    ...
                    <div class="widget-content nopadding">
                        ...
                        <table class="table table-bordered data-table">
                            <tbody>
                                ...
                                <?php
                                if (!empty($_POST)) {
                                    $counties[] = $system_administration->execute();
                                } else {
                                    $counties[] = $system_administration->getAllCounties();
                                }
                                if (isset($_SESSION['no_records']) AND $_SESSION['no_records'] == true) {
                                    ...
                                    foreach ($counties as $key => $value) {
                                        ...
                                        foreach ((array) $inner_array[$key] as $key2 => $value2) {
                                            ...
                                            echo "<tr>";
                                            echo "<td> <a href='?individual_county&code=" . $value2['id'] . "'>" . $value2['id'] . "</td>";

...
unset($_SESSION['book_level']);
?>

<div id="content">
    <div id="content-header">
        <div id="breadcrumb"> <a href="?home" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="?view_book_levels" class="current">Book Levels</a> </div>
        <h1>Book Levels</h1>
    </div>
                    ...
                    <div class="widget-content nopadding">
                        ...
                        <table class="table table-bordered data-table">
                            <tbody>
                                ...
                                <?php
                                if (!empty($_POST)) {
                                    $book_levels[] = $system_administration->execute();
                                } else {
                                    $book_levels[] = $system_administration->getAllBookLevels();
                                }
                                if (isset($_SESSION['no_records']) AND $_SESSION['no_records'] == true) {
                                    ...
                                    foreach ($book_levels as $key => $value) {
                                        ...
                                        foreach ((array) $inner_array[$key] as $key2 => $value2) {
                                            ...
                                            echo "<tr>";
                                            echo "<td> <a href='?individual_book_level&code=" . $value2['id'] . "'>" . $value2['id'] . "</td>";

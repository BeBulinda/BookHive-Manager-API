...
<div id="content">
    <div id="content-header">
        <div id="breadcrumb"> <a href="?home" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="?view_schools" class="current">Schools</a> </div>
        <h1>Schools</h1>
    </div>
                    ...
                    <div class="widget-content nopadding">
                        ...
                        <table class="table table-bordered data-table">
                            <tbody>
                                <tr>
                                    <th><h5>ID</h5></th>
                                    <th><h5>School Name</h5></th>
                                    <th><h5>School Type</h5></th>
                                ...
                                if (!empty($_POST)) {
                                    ...
                                    $publishers[] = $users->getAllSchools();
                                }

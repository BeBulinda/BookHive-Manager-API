...
<div id="content">
    <div id="content-header">
        <div id="breadcrumb"> <a href="?home" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="?view_roles" class="current">Roles</a> </div>
        <h1>Roles</h1>
    </div>
                    ...
                    <div class="widget-content nopadding">
                        ...
                        <table class="table table-bordered data-table">
                            <tbody>
                                ...
                                <?php
                                if (!empty($_POST)) {
                                    $roles[] = $system_administration->execute();
                                } else {
                                    $roles[] = $system_administration->getAllRoles();
                                }

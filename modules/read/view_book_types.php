...
<div id="content">
    <div id="content-header">
        <div id="breadcrumb"> <a href="?home" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="?view_book_types" class="current">Book Types</a> </div>
        <h1>Book Types</h1>
    </div>
                    ...
                    <div class="widget-content nopadding">
                        ...
                        <table class="table table-bordered data-table">
                            <tbody>
                                ...
                                <?php
                                if (!empty($_POST)) {
                                    $book_types[] = $system_administration->execute();
                                } else {
                                    $book_types[] = $system_administration->getAllBookTypes();
                                }
                                if (isset($_SESSION['no_records']) AND $_SESSION['no_records'] == true) {
                                    ...
                                    foreach ($book_types as $key => $value) {
                                        ...
                                        foreach ((array) $inner_array[$key] as $key2 => $value2) {
                                            ...
                                            echo "<tr>";
//                                            echo "<td> <a href='?individual_book_type&code=" . $value2['id'] . "'>" . $value2['id'] . "</td>";

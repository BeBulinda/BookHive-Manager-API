...
<div id="content">
    <div id="content-header">
        <div id="breadcrumb"> <a href="?home" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="?view_payment_options" class="current">Payment Options</a> </div>
                    ...
                    <div class="widget-content nopadding">
                        ...
                        <table class="table table-bordered data-table">
                            <tbody>
                                ...
                                <?php
                                if (!empty($_POST)) {
                                    $payment_options[] = $system_administration->execute();
                                } else {
                                    $payment_options[] = $system_administration->getAllPaymentOptions();
                                }
                                if (isset($_SESSION['no_records']) AND $_SESSION['no_records'] == true) {
                                    ...
                                    foreach ($payment_options as $key => $value) {
                                        ...
                                        foreach ((array) $inner_array[$key] as $key2 => $value2) {
                                            ...
                                            echo "<tr>";
//                                            echo "<td> <a href='?individual_payment_option&code=" . $value2['id'] . "'>" . $value2['id'] . "</td>";

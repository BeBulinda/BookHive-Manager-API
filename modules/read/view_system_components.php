...
unset($_SESSION['system_component']);
?>

<div id="content">
    <div id="content-header">
        <div id="breadcrumb"> <a href="?home" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="?view_system_components" class="current">System Components</a> </div>
                    ...
                    <div class="widget-content nopadding">
                        ...
                        <table class="table table-bordered data-table">
                            <tbody>
                                ...
                                <?php
                                if (!empty($_POST)) {
                                    $system_components[] = $system_administration->execute();
                                } else {
                                    $system_components[] = $system_administration->getAllSystemComponents();
                                }
                                if (isset($_SESSION['no_records']) AND $_SESSION['no_records'] == true) {
                                    ...
                                    foreach ($system_components as $key => $value) {
